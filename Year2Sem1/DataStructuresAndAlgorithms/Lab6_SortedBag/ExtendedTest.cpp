...
void testUniqueCount(Relation rel) {
    cout << "Test Unique Count" << endl;
    SortedBag sb(rel);
    for (int i=0; i<10; i++) {
        sb.add(i);
    }
    assert(sb.uniqueCount()==10);
    for (int i=0; i<10; i++) {
        sb.add(i);
    }
    ...
    assert(sb.uniqueCount()==110);
    for (int i=100; i<200; i=i+10) {
        sb.add(i);
    }
    assert(sb.uniqueCount()==100);
    for (int i=100; i<200; i=i+10) {
        sb.remove(i);
    }
    assert(sb.uniqueCount()==110);
...
void testAllExtended() {
    ...
    testUniqueCount(relation2);
    testUniqueCount(relation3);
}
